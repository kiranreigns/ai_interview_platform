<div align="center">
  <h1 align="center">Prepwise: AI - Powered Mock Interview Platform</h1>
  <br />
      <img src="./public/interview_screenshot.jpeg" alt="Project Banner">
  <br />
  ...
  <div>
    ...
    <img src="https://img.shields.io/badge/-ImageKit-black?style=for-the-badge&logoColor=white&logo=imagekit&color=000000" alt="imagekit" />
  </div>
</div>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, Imagekit for storing user profile pictures, styled with TailwindCSS and Vapi for voice agents, Prepwise is a website project designed to help users prepare for job interviews. The platform offers a sleek and modern experience for job interview preparation.
...
👉 **Profile**: Customize your profile with a photo upload and update options.
...
```bash
git clone https://github.com/kiranreigns/ai_interview_platform.git
...
Replace the placeholder values with your actual **[Firebase](https://firebase.google.com/)**, **[Vapi](https://vapi.ai/?utm_source=youtube&utm_medium=video&utm_campaign=jsmastery_recruitingpractice&utm_content=paid_partner&utm_term=recruitingpractice)** and **[ImageKit](https://imagekit.io/)** credentials.
